...
class TLSCipherSuite
  def initialize(ciphersuite)
    ...
    @internal_cs = @external_cs.map do |c|
      c.instance_of?(Array) ? TLSCipherSuite.by_arr(c) : TLSCipherSuite.by_hexstr(c)
    end
  ...
  def set_length_noscsv
    @internal_cs.reject { |x| x[:scsv] }.length
  end
  ...
  def self.cipher_to_h(val)
    { code: val[0], keyxchange: val[1], auth: val[2], encryption: val[3], mode: val[4], mac: val[5], pfs: val[6],
  ...
  KNOWN_CIPHERSUITES = [
    ...
    [ [0x00, 0x8C], 'PSK',     'PSK',     'AES128',      'CBC',     'SHA',      false, false, false, 'TLS_PSK_WITH_AES_128_CBC_SHA'],
    [ [0x00, 0x8D], 'PSK',     'PSK',     'AES256',      'CBC',     'SHA',      false, false, false, 'TLS_PSK_WITH_AES_256_CBC_SHA'],
    [ [0x00, 0x90], 'DHE',     'PSK',     'AES128',      'CBC',     'SHA',      true,  false, false, 'TLS_DHE_PSK_WITH_AES_128_CBC_SHA'],
    [ [0x00, 0x91], 'DHE',     'PSK',     'AES256',      'CBC',     'SHA',      true,  false, false, 'TLS_DHE_PSK_WITH_AES_256_CBC_SHA'],
    [ [0x00, 0x94], 'RSA',     'PSK',     'AES128',      'CBC',     'SHA',      false, false, false, 'TLS_RSA_PSK_WITH_AES_128_CBC_SHA'],
    [ [0x00, 0x95], 'RSA',     'PSK',     'AES256',      'CBC',     'SHA',      false, false, false, 'TLS_RSA_PSK_WITH_AES_256_CBC_SHA'],
    ...
    [ [0x00, 0xA8], 'PSK',     'PSK',     'AES128',      'GCM',     'SHA256',   false, false, false, 'TLS_PSK_WITH_AES_128_GCM_SHA256'],
    [ [0x00, 0xA9], 'PSK',     'PSK',     'AES256',      'GCM',     'SHA384',   false, false, false, 'TLS_PSK_WITH_AES_256_GCM_SHA384'],
    [ [0x00, 0xAA], 'DHE',     'PSK',     'AES128',      'GCM',     'SHA256',   true,  false, false, 'TLS_DHE_PSK_WITH_AES_128_GCM_SHA256'],
    [ [0x00, 0xAB], 'DHE',     'PSK',     'AES256',      'GCM',     'SHA384',   true,  false, false, 'TLS_DHE_PSK_WITH_AES_256_GCM_SHA384'],
    [ [0x00, 0xAC], 'RSA',     'PSK',     'AES128',      'GCM',     'SHA256',   false, false, false, 'TLS_RSA_PSK_WITH_AES_128_GCM_SHA256'],
    [ [0x00, 0xAD], 'RSA',     'PSK',     'AES256',      'GCM',     'SHA384',   false, false, false, 'TLS_RSA_PSK_WITH_AES_256_GCM_SHA384'],
    [ [0x00, 0xAE], 'PSK',     'PSK',     'AES128',      'CBC',     'SHA256',   false, false, false, 'TLS_PSK_WITH_AES_128_CBC_SHA256'],
    [ [0x00, 0xAF], 'PSK',     'PSK',     'AES256',      'CBC',     'SHA384',   false, false, false, 'TLS_PSK_WITH_AES_256_CBC_SHA384'],
    [ [0x00, 0xAB], 'DHE',     'PSK',     'AES256',      'GCM',     'SHA384',   true,  false, false, 'TLS_DHE_PSK_WITH_AES_256_GCM_SHA384'],
    [ [0x00, 0xB2], 'DHE',     'PSK',     'AES128',      'CBC',     'SHA256',   true,  false, false, 'TLS_DHE_PSK_WITH_AES_128_CBC_SHA256'],
    [ [0x00, 0xB3], 'DHE',     'PSK',     'AES256',      'CBC',     'SHA384',   true,  false, false, 'TLS_DHE_PSK_WITH_AES_256_CBC_SHA384'],
    [ [0x00, 0xB6], 'RSA',     'PSK',     'AES128',      'CBC',     'SHA256',   false, false, false, 'TLS_RSA_PSK_WITH_AES_128_CBC_SHA256'],
    [ [0x00, 0xB7], 'RSA',     'PSK',     'AES256',      'CBC',     'SHA384',   false, false, false, 'TLS_RSA_PSK_WITH_AES_256_CBC_SHA384'],
    ...
    [ [0x0A, 0x0A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x0A)'],
    ...
    [ [0x1A, 0x1A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x1A)'],
    [ [0x2A, 0x2A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x2A)'],
    [ [0x3A, 0x3A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x3A)'],
    [ [0x4A, 0x4A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x4A)'],
    [ [0x56, 0x00], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'TLS_FALLBACK_SCSV'],
    [ [0x5A, 0x5A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x5A)'],
    [ [0x6A, 0x6A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x6A)'],
    [ [0x7A, 0x7A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x7A)'],
    [ [0x8A, 0x8A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x8A)'],
    [ [0x9A, 0x9A], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0x9A)'],
    [ [0xAA, 0xAA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xAA)'],
    [ [0xBA, 0xBA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xBA)'],
    ...
    [ [0xC0, 0x35], 'ECDHE',   'PSK',     'AES128',      'CBC',     'SHA',      true,  false, false, 'TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA'],
    [ [0xC0, 0x36], 'ECDHE',   'PSK',     'AES256',      'CBC',     'SHA',      true,  false, false, 'TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA'],
    [ [0xC0, 0x37], 'ECDHE',   'PSK',     'AES128',      'CBC',     'SHA256',   true,  false, false, 'TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256'],
    [ [0xC0, 0x38], 'ECDHE',   'PSK',     'AES256',      'CBC',     'SHA384',   true,  false, false, 'TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384'],
    ...
    [ [0xC0, 0xA4], 'PSK',     'PSK',     'AES128',      'CTR',     'CCM',      false, false, false, 'TLS_PSK_WITH_AES_128_CCM'],
    [ [0xC0, 0xA5], 'PSK',     'PSK',     'AES256',      'CTR',     'CCM',      false, false, false, 'TLS_PSK_WITH_AES_256_CCM'],
    [ [0xC0, 0xA6], 'DHE',     'PSK',     'AES128',      'CTR',     'CCM',      true,  false, false, 'TLS_DHE_PSK_WITH_AES_128_CCM'],
    [ [0xC0, 0xA7], 'DHE',     'PSK',     'AES256',      'CTR',     'CCM',      true,  false, false, 'TLS_DHE_PSK_WITH_AES_256_CCM'],
    [ [0xC0, 0xA8], 'PSK',     'PSK',     'AES128',      'CTR',     'CCM8',     false, false, false, 'TLS_PSK_WITH_AES_128_CCM_8'],
    [ [0xC0, 0xA9], 'PSK',     'PSK',     'AES256',      'CTR',     'CCM8',     false, false, false, 'TLS_PSK_WITH_AES_256_CCM_8'],
    [ [0xC0, 0xAA], 'DHE',     'PSK',     'AES128',      'CTR',     'CCM8',     true,  false, false, 'TLS_PSK_DHE_WITH_AES_128_CCM_8'],
    [ [0xC0, 0xAB], 'DHE',     'PSK',     'AES256',      'CTR',     'CCM8',     true,  false, false, 'TLS_PSK_DHE_WITH_AES_256_CCM_8'],
    ...
    [ [0xCA, 0xCA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xCA)'],
    ...
    [ [0xCC, 0xAB], 'PSK',     'PSK',     'CHACHA20',    nil,       'POLY1305', false, false, false, 'TLS_PSK_WITH_CHACHA20_POLY1305_SHA256'],
    [ [0xCC, 0xAC], 'ECDHE',   'PSK',     'CHACHA20',    nil,       'POLY1305', true,  false, false, 'TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256'],
    [ [0xCC, 0xAD], 'DHE',     'PSK',     'CHACHA20',    nil,       'POLY1305', true,  false, false, 'TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256'],
    [ [0xD0, 0x01], 'ECDHE',   'PSK',     'AES128',      'GCM',     'SHA256',   true,  false, false, 'TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256'],
    [ [0xDA, 0xDA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xDA)'],
    [ [0xEA, 0xEA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xEA)'],
    [ [0xFA, 0xFA], nil,       nil,       nil,           nil,       nil,        nil,   true,  false, 'GREASE (0xFA)'],
    # [ [0xE0, 0x13]],
...
class TLSServerKeyExchange
  ...
  # Parse Key Exchange
  # @return [TLSServerKeyExchange::ECDHE] parsed ECDHE Key Exchange
  # @todo DHE is not yet supported
  def self.parse(data, cipher, version)
    TLSServerKeyExchange::ECDHE.new(data, version) if TLSCipherSuite.by_arr(cipher)[:keyxchange] == 'ECDHE'
  end
end
